...
<section class="container py-5">
    ...
    <div id="single-lesson-plans-container" class="studio-table-container studio-table-container-lg">
        <table id="single-lesson-plans-table" class="display studio-table">
            <thead>
                <tr>
                    <th>Student</th>
                    <th>Date</th>
...
$(function() {
    ...
    const singleLessonPlansTable = window.studioDataTableState.create('#single-lesson-plans-table', {
        processing: false,
        serverSide: true,
        autoWidth: false,
        scrollX: true,
        ...
        ajax: {
            url: @json(route('studio.tables.single-lesson-plans')),
            data: function(data) {
        ...
        columns: [
            ...
            },
            {
                ...
                render: function(data) {
                    const editUrl = @json(route('studio.single-lesson-plans.edit', ['singleLessonPlan' => '__singleLessonPlan__'])).replace('__singleLessonPlan__', data);
                    const deleteUrl = @json(route('studio.single-lesson-plans.destroy', ['singleLessonPlan' => '__singleLessonPlan__'])).replace('__singleLessonPlan__', data);
