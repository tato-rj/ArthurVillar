...
<section class="container py-5">
    ...
    <div id="breaks-container" class="studio-table-container studio-table-container-lg">
        <table id="breaks-table" class="display studio-table">
            <thead>
                <tr>
                    <th>Title</th>
                    <th>Locations</th>
...
@include('studio.breaks.partials.form', [
    'id' => 'create-break-modal',
    'title' => 'New break',
    'formId' => 'create-break-form',
    'method' => 'POST',
    'action' => route('studio.breaks.store'),
])
...
$(function() {
    ...
    const breaksTable = window.studioDataTableState.create('#breaks-table', {
        ...
        columns: [
            ...
            },
            {
                ...
                render: function(data) {
                    const deleteUrl = @json(route('studio.breaks.destroy', ['break' => '__break__'])).replace('__break__', data);
    ...
    $('#breaks-table').on('click', '.js-edit-break', function() {
        ...
        const updateUrl = @json(route('studio.breaks.update', ['break' => '__break__'])).replace('__break__', teachingBreak.id);
