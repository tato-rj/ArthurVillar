...
<form method="POST" action="" id="recital-participants-form">
    ...
    <div class="form-group text-left">
        ...
        <div class="studio-student-combobox" data-recital-student-combobox>
            ...
            <div class="studio-student-combobox-menu" data-recital-student-menu>
                ...
                @endforeach
                <div class="studio-student-combobox-empty" data-recital-student-empty>No students found</div>
            </div>
        </div>
    </div>
