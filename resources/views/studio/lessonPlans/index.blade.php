...
<section class="container py-5">
    ...
    <div id="lesson-plans-container" class="studio-table-container studio-table-container-lg">
        <table id="lesson-plans-table" class="display studio-table">
            <thead>
                <tr>
                    <th>Student</th>
                    <th>Weekday</th>
...
$(function() {
    ...
    const lessonPlansTable = window.studioDataTableState.create('#lesson-plans-table', {
        ...
        ajax: {
            url: @json(route('studio.tables.lesson-plans')),
            data: function(data) {
        ...
        columns: [
            ...
            },
            {
                ...
                render: function(data) {
                    const editUrl = @json(route('studio.lesson-plans.edit', ['lessonPlan' => '__lessonPlan__'])).replace('__lessonPlan__', data);
                    const deleteUrl = @json(route('studio.lesson-plans.destroy', ['lessonPlan' => '__lessonPlan__'])).replace('__lessonPlan__', data);
