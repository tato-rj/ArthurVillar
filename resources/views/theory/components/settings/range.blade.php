  <div class="mb-2">
    ...
    <input type="range" name="initialNoteRange" class="form-range mt-2 big-thumb" data-range-labels="#initialNoteRangeLabels" min="0" max="2" step="1" id="{{$modalID ?? null}}-range" value="{{$settings->options('initialNoteRange')}}">
