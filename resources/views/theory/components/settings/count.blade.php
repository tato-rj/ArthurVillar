<div class="d-apart mb-2">
  ...
  <div class="d-center form-number">
    ...
    <input type="text" readonly name="{{$name}}" max="{{$max}}" min="{{$min}}" value="{{request($name) ?? $settings->options($name)}}" class="form-control form-control-sm py-1 mx-2 text-center border-light" style="width: 52px;">
