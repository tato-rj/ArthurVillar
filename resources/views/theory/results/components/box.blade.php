<div class="col-6 animate__animated animate__bounceIn">
	<div class="w-100 bg-light border border-dark {{$color}} position-relative rounded p-1 mb-3" style="border-radius: 16px !important;">
		@if($name == 'score')
		...
		@endif
		<div class="pb-1 text-center fw-bold opacity-6" style="font-size: 70%">{{$title}}</div>
		<div class="text-{{$color}} border border-dark bg-white rounded fw-bold d-center px-2 py-3 h5 m-0" style="border-radius: 16px !important;">
