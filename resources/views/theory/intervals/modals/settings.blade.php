...
<form id="intervals-settings" method="GET" action="{{route('theory.intervals.play')}}">
	...
	<div class="d-apart mb-3">
		...
		<div class="d-center form-number">
			<button style="touch-action: manipulation;" type="button" data-direction="down" class="btn-raw">@fa(['icon' => 'minus', 'mr' => 0, 'fa_size' => 'xl'])</button>
			...
			<button style="touch-action: manipulation;" type="button" data-direction="up" class="btn-raw">@fa(['icon' => 'plus', 'mr' => 0, 'fa_size' => 'xl'])</button>
		</div>
