<div class="dropdown position-absolute top-0 end-0">
	<button id="user-avatar" type="button" aria-label="Your avatar" data-avatar-base="{{asset('images/avatars')}}/" style="padding: 0;" data-bs-toggle="dropdown" data-bs-offset="0,12" aria-expanded="false" aria-controls="user-avatar-menu" disabled>
