...
<section id="page-wrapper" class="container prevent-select">
  <div class="row">
    ...
    <div class="col-lg-6 col-md-8 col-11 mx-auto">
      @include('theory.components.controls', ['instructions' => 'Read the note and play it out loud 👆'])
      @include('theory.note-match.settings')
...
<script src="{{ mix('js/music/notematch.js') }}"></script>
<script>
  $(function () {
