	...
	<div id="calendar-calendar-insights" class="">
		<h6 class="mb-3">Calendar insights</h6>
		<div id="calendar-calendar-insights-birthdays" style="display: none;" class="mb-3 text-blue">
		...
		<div class="mb-3" style="display: none;">
			...
			<label style="font-size: .75em;">AVERAGE</label>
		</div>
		<div class="mb-3">
			<div class="d-flex align-items-center">
				<h6 class="m-0" data-calendar-confirmed-payment>$0</h6>
