<div class="calendar-calendar-settings">
	<button type="button" class="btn-raw calendar-calendar-icon-button calendar-calendar-header-control px-2" data-bs-toggle="modal" data-bs-target="#settings-modal" aria-label="Open settings">
