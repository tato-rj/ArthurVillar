		<div class="calendar-calendar-toolbar-search calendar-calendar-search rounded">
			...
			<button type="button" class="btn-raw calendar-calendar-icon-button calendar-calendar-search-clear calendar-calendar-header-control" data-calendar-search-clear aria-label="Clear search">
				@fa(['icon' => 'xmark', 'mr' => 0])
			</button>
		</div>
