<div class="calendar-calendar-google-accounts hide-in-mobile">
	<button type="button" class="btn-raw calendar-calendar-icon-button calendar-calendar-header-control px-2" data-bs-toggle="modal" data-bs-target="#google-accounts-modal" aria-label="Open google accounts" style="font-size: 1.2rem;">
