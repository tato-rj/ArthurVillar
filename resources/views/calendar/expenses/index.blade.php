...
<section class="container py-5">
    {{ Breadcrumbs::render('calendar.expenses.index') }}
    ...
    <div id="expenses-container" class="calendar-table-container calendar-table-container-lg">
        <table id="expenses-table" class="display calendar-table">
            <thead>
                <tr>
                    <th>Name</th>
                    <th>Amount</th>
...
@include('calendar.expenses.create')
...
$(function() {
    ...
    const expensesTable = window.calendarDataTableState.create('#expenses-table', {
        processing: false,
        serverSide: true,
        autoWidth: false,
        scrollX: true,
        ...
        ajax: @json(route('calendar.tables.expenses')),
        columns: [
            {data: 'name', name: 'name'},
            {
                data: 'amount',
            ...
            },
            {
                ...
                render: function(data) {
                    const editUrl = @json(route('calendar.expenses.edit', ['expense' => '__expense__'])).replace('__expense__', data);
                    const deleteUrl = @json(route('calendar.expenses.destroy', ['expense' => '__expense__'])).replace('__expense__', data);
