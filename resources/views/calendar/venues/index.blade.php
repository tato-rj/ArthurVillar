...
<section class="container py-5">
    {{ Breadcrumbs::render('calendar.venues.index') }}
    ...
    <div id="venues-container" class="calendar-table-container calendar-table-container-lg">
        <table id="venues-table" class="display calendar-table">
            <thead>
                <tr>
                    <th>Name</th>
                    <th>Address</th>
...
@include('calendar.venues.create')
...
$(function() {
    ...
    window.calendarDataTableState.create('#venues-table', {
        processing: false,
        serverSide: true,
        autoWidth: false,
        scrollX: true,
        ...
        ajax: @json(route('calendar.tables.venues')),
        columns: [
            {data: 'name', name: 'name'},
            ...
            {data: 'postal_code', name: 'postal_code', defaultContent: ''},
            {
                ...
                render: function(data, type, row) {
                    const editUrl = @json(route('calendar.venues.edit', ['venue' => '__venue__'])).replace('__venue__', data);
                    const deleteUrl = @json(route('calendar.venues.destroy', ['venue' => '__venue__'])).replace('__venue__', data);
