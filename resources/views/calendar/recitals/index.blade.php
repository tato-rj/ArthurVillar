...
<section class="container py-5">
    ...
    <div id="recitals-container" class="calendar-table-container calendar-table-container-lg">
        <table id="recitals-table" class="display calendar-table">
            <thead>
                <tr>
                    <th>Name</th>
                    <th>Date</th>
...
@include('calendar.recitals.create')
@include('calendar.recitals.participants')
...
$(function() {
    ...
    const table = window.calendarDataTableState.create('#recitals-table', {
        processing: false,
        serverSide: true,
        autoWidth: false,
        scrollX: true,
        ...
        ajax: @json(route('calendar.tables.recitals')),
        columns: [
            {data: 'name', name: 'name'},
            ...
            },
            {
                ...
                render: function(data) {
                    const editUrl = @json(route('calendar.recitals.edit', ['recital' => '__recital__'])).replace('__recital__', data);
                    const studentsUrl = @json(route('calendar.recitals.students.update', ['recital' => '__recital__'])).replace('__recital__', data);
                    const deleteUrl = @json(route('calendar.recitals.destroy', ['recital' => '__recital__'])).replace('__recital__', data);
