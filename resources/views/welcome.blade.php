            ...
            <div>
                ...
                <div style="margin-top: 28px">
                    <div class="button-wrapper">
                        <a href="https://bkcm.org/suzuki-faculty/" target="_blank" class="button-52">Brooklyn Conservatory of Music</a>
                    </div>

                    <div class="button-wrapper">
                        <a href="https://pianolessonsinjerseycity.com/" target="_blank" class="button-52">Private piano studio</a>
                    </div>
                    
                    <div class="button-wrapper">
                        <a href="https://pianolit.com/" target="_blank" class="button-52">PianoLIT</a>
                    </div>
                    <div style="display: flex; align-items: center; justify-content: center">
                        <div style="margin-right: 6px; margin-left: 6px">
                            <a href="https://youtube.com/pianolit" target="_blank"><i class="fa-brands fa-youtube fa-lg"></i></a>
                        </div>
