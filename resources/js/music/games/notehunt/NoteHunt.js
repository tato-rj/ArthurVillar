...
export class NoteHunt extends BaseStaffGame {
  ...
  _displayNameForLetter(letter) {
    ...
    if (this._showSolfegeNoteNames()) return NoteHunt.LETTER_TO_SOLFEGE[clean] || clean;
    return clean;
  }
  ...
  _setPromptForTarget(target) {
    ...
    this.prompt.setLong("NoteHunt scaffold challenge");
  }
