...
use Carbon\Carbon;
use App\Models\Calendar\{Expense, Location};
...
class ExpensesController extends Controller
{
    ...
    {
        return view('calendar.expenses.index');
    }
    ...
    public function report(Scheduler $scheduler)
    {
        ...
        return view('calendar.expenses.report', compact('months', 'startsFrom', 'startsTo', 'averageIncome', 'averageSavings', 'locations', 'simulation', 'simulationEnabled'));
    }
    ...
    {
        return view('calendar.expenses.edit', compact('expense'));
    }
