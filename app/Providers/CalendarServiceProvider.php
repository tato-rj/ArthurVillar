    ...
    public function boot()
    {
        View::composer('calendar.index', function ($view) {
            ...
            $view->with([
                ...
                'animateCalendarEvents' => $value('calendar.animate_events'),
                ...
                'selectedAppearanceTheme' => old('appearance_theme', $value('appearance.theme')),
