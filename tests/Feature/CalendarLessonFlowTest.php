...
class CalendarLessonFlowTest extends BaseTest
{
    ...
    public function it_does_not_create_a_lesson_plan_that_overlaps_another_complete_lesson_plan()
    {
        ...
        $response = $this->from(route('calendar.students.index'))->post(route('calendar.lesson-plans.store'), $this->lessonPlanPayload([
    ...
    public function it_does_not_update_a_lesson_plan_to_overlap_another_complete_lesson_plan()
    {
        ...
        $this->from(route('calendar.lessons.student', $student))
            ->patch(route('calendar.lesson-plans.update', $lessonPlan), $this->lessonPlanPayload([
                'student_id' => $student->id,
                'starts_on' => '08/01/2026',
                'ends_on' => '08/31/2026',
            ]))
            ->assertRedirect(route('calendar.lessons.student', $student))
            ->assertSessionHasErrors(['starts_on' => 'This lesson plan overlaps with another lesson plan.']);
    ...
    public function it_can_create_a_lesson_plan_when_the_previous_plan_ended_today()
    {
        ...
        $response = $this->post(route('calendar.lesson-plans.store'), $this->lessonPlanPayload([
            'student_id' => $student->id,
    ...
    public function it_duplicates_a_current_lesson_plan_without_dates()
    {
        ...
        $this->post(route('calendar.lesson-plans.duplicate', $lessonPlan))
            ->assertRedirect();
    ...
    public function it_calculates_the_lesson_plan_fee_from_the_location_hourly_fee_duration_and_lower_five_dollars()
    {
        ...
        $this
            ->post(route('calendar.lesson-plans.store'), $this->lessonPlanPayload([
                'duration_minutes' => 30,
                'fee_amount' => '',
    ...
    public function it_reschedules_a_single_lesson_occurrence()
    {
        ...
        $response = $this->from(route('calendar.home'))->post(route('calendar.lesson-plans.reschedule'), [
    ...
    public function it_does_not_reschedule_a_lesson_to_its_current_time()
    {
        ...
        $this
            ->from(route('calendar.home'))
            ->post(route('calendar.lesson-plans.reschedule'), [
                'lesson_plan_id' => $lessonPlan->id,
                'original_date' => '2026-07-08',
                'original_start_time' => '15:30',
                'date' => '2026-07-08',
    ...
    public function it_cancels_a_lesson_occurrence_with_a_normal_form_post()
    {
        ...
        $response = $this->from(route('calendar.home'))->post(route('calendar.lessons.cancel'), [
            'lesson_plan_id' => $lessonPlan->id,
            'date' => '2026-07-08',
            'start' => '15:30',
            'end' => '16:15',
    ...
    public function canceling_a_rescheduled_lesson_preserves_the_schedule_override()
    {
        ...
        $this->post(route('calendar.lessons.cancel'), [
            'lesson_plan_id' => $lessonPlan->id,
            'date' => '2026-07-09',
            'start' => '16:00',
            'end' => '16:30',
    ...
    public function confirming_a_single_lesson_plan_creates_a_single_lesson_and_keeps_the_pending_plan()
    {
        ...
        $this->postJson(route('calendar.lessons.store'), [
            'single_lesson_plan_id' => $singleLessonPlan->id,
            'date' => '2026-07-15',
            'start' => '15:30',
            'end' => '16:15',
    ...
    public function calendar_modal_can_reschedule_a_lesson_with_json()
    {
        ...
        $this->postJson(route('calendar.lesson-plans.reschedule'), [
            'lesson_plan_id' => $lessonPlan->id,
            'original_date' => '2026-07-08',
            'original_start_time' => '15:30',
            'date' => '2026-07-09',
    ...
    public function calendar_modal_can_cancel_a_lesson_with_json()
    {
        ...
        $this->postJson(route('calendar.lessons.cancel'), [
            'lesson_plan_id' => $lessonPlan->id,
            'date' => '2026-07-08',
            'start' => '15:30',
            'end' => '16:15',
