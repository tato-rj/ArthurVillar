...
var BaseStaffGame = /*#__PURE__*/function () {
  ...
  return _createClass(BaseStaffGame, [{
    ...
    value: function _playPerfectGameBonusSfx() {
      ...
      if (!this.isSoundEnabled() || !window.Tone) return;
      this._ensureUiSfxAudio().then(function () {
        var _this7$_uiSfxSynth$ge;
        if (!_this7._uiSfxSynth) return;
        var oldEnv = _objectSpread({}, _this7._uiSfxSynth.get().envelope);
        var oldOsc = (_this7$_uiSfxSynth$ge = _this7._uiSfxSynth.get().oscillator) === null || _this7$_uiSfxSynth$ge === void 0 ? void 0 : _this7$_uiSfxSynth$ge.type;
        try {
          _this7._uiSfxSynth.set({
            oscillator: {
              type: "triangle"
            },
            envelope: {
        ...
        fanfare.forEach(function (n, i) {
          _this7._uiSfxSynth.triggerAttackRelease(n, 0.09, now + i * 0.06, 0.62);
        });
        var hit = ["C6", "G6", "C7", "E7"];
        hit.forEach(function (n) {
          return _this7._uiSfxSynth.triggerAttackRelease(n, 0.35, now + 0.48, 0.46);
        });
        setTimeout(function () {
          try {
            _this7._uiSfxSynth.set({
    ...
    value: function _finishRoundAsTimedOut() {
      ...
      if (reachedEnd && !this._isPracticeMode()) {
        ...
        setTimeout(function () {
          return _this8._showFinalResults();
        }, 1600);
        return;
      }
    ...
    value: function _runGameTimerTick() {
      ...
      this._timerTimeoutId = setTimeout(function () {
        return _this9._runGameTimerTick();
      }, delay);
    }
  }, {
    key: "_startGameTimer",
    ...
    value: function _wireStaffTools() {
      ...
      this.$staffEl.off("staff:noteState._log.".concat(this.ns)).on("staff:noteState._log.".concat(this.ns), function (e, data) {
        var full = (0,_staff_staffUtils_js__WEBPACK_IMPORTED_MODULE_1__.spellNoteFromState)(_this0.staff, data.step, data.accidentalClass);
        var letterOnly = full.replace(/\d+$/, "");
        if (_this0.showLetterNames) {
          _this0.$staffEl.find(".note[data-note-id=\"".concat(data.noteId, "\"] .lettername")).text(letterOnly);
        }
        if (data.source === "fixed") {
          var _this0$_onFixedNoteSt;
          _this0._fixedNote = {
          ...
          (_this0$_onFixedNoteSt = _this0._onFixedNoteState) === null || _this0$_onFixedNoteSt === void 0 || _this0$_onFixedNoteSt.call(_this0, data, full, letterOnly);
        }
    ...
    value: function _armUiGates() {
      ...
      this.$staffEl.off("staff:userNoteAdded._uiGate.".concat(this.ns)).on("staff:userNoteAdded._uiGate.".concat(this.ns), function () {
        _this10._userNotesSinceGate += 1;
        if (!_this10._instructionsRemoved && _this10._userNotesSinceGate >= needForInstructions) {
          $("#instructions").remove();
          _this10._instructionsRemoved = true;
        }
        if (_this10._userNotesSinceGate >= needForCheck) {
          $("#check").removeClass("invisible");
          _this10.$staffEl.off("staff:userNoteAdded._uiGate.".concat(_this10.ns));
        }
      });
    }
    ...
    value: function _removeAllHintNotes() {
      ...
      ids.forEach(function (id) {
        return _this11.staff.removeNote(id);
      });
      this._activeHintIds = [];
    }
  }, {
    ...
    value: function _attachHintBlinkRemoval(noteId) {
      ...
      $note.off("animationend.hint.".concat(noteId, " webkitAnimationEnd.hint.").concat(noteId)).one("animationend.hint.".concat(noteId, " webkitAnimationEnd.hint.").concat(noteId), function () {
        _this12.staff.removeNote(noteId);
        _this12._activeHintIds = (_this12._activeHintIds || []).filter(function (x) {
          return x !== noteId;
        });
      });
    }
    ...
    value: function _showFinalResults() {
      ...
      if (perfectGame) {
        setTimeout(function () {
          var _this14$$doublePoints, _this14$$doublePoints2;
          (_this14$$doublePoints = _this14.$doublePoints) === null || _this14$$doublePoints === void 0 || (_this14$$doublePoints2 = _this14$$doublePoints.show) === null || _this14$$doublePoints2 === void 0 || _this14$$doublePoints2.call(_this14$$doublePoints);
          _this14._playPerfectGameBonusSfx();
        }, 1750);
      ...
      var countTo = function countTo(selector, endVal) {
        ...
        var el = _this14.$finalOverlay.find(selector)[0];
        if (!el) return;
        if (!CountUpCtor) {
