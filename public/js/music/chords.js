  ...
  return _createClass(BaseStaffGame, [{
    ...
    value: function _playSuccessSfxBasic() {
      ...
      this._ensureUiSfxAudio().then(function () {
        if (!_this2._uiSfxSynth) return;
        var now = Tone.now();
        var notes = ["C6", "E6", "G6"];
        notes.forEach(function (n, i) {
          _this2._uiSfxSynth.triggerAttackRelease(n, 0.07, now + i * 0.05, 0.42);
        });
      });
    }
  }, {
    ...
    value: function _playSuccessSfxBonus() {
      ...
      if (!this.isSoundEnabled() || !window.Tone) return;
      this._ensureUiSfxAudio().then(function () {
        var _this3$_uiSfxSynth$ge;
        if (!_this3._uiSfxSynth) return;
        var now = Tone.now();
        var oldEnv = _objectSpread({}, _this3._uiSfxSynth.get().envelope);
        var oldOsc = (_this3$_uiSfxSynth$ge = _this3._uiSfxSynth.get().oscillator) === null || _this3$_uiSfxSynth$ge === void 0 ? void 0 : _this3$_uiSfxSynth$ge.type;
        try {
          _this3._uiSfxSynth.set({
            oscillator: {
              type: "sine"
            },
            envelope: {
        ...
        var arp = ["C6", "E6", "G6", "B6", "C7"];
        arp.forEach(function (n, i) {
          _this3._uiSfxSynth.triggerAttackRelease(n, 0.06, now + i * 0.045, 0.45);
        });
        var chord = ["C6", "G6", "C7", "E7"];
        chord.forEach(function (n) {
          _this3._uiSfxSynth.triggerAttackRelease(n, 0.12, now + 0.26, 0.30);
        });
        setTimeout(function () {
          try {
            _this3._uiSfxSynth.set({
    ...
    value: function _playFailSfx() {
      ...
      this._ensureUiSfxAudio().then(function () {
        var now = Tone.now();
        if (_this4._uiSfxNoise) {
          _this4._uiSfxNoise.triggerAttackRelease(0.06, now, 0.1);
        }
        if (_this4._uiSfxSynth) {
          _this4._uiSfxSynth.triggerAttackRelease("A2", 0.10, now + 0.01, 0.1);
          _this4._uiSfxSynth.triggerAttackRelease("G2", 0.12, now + 0.08, 10.1);
        }
      });
    }
  }, {
    ...
    value: function _playFinalSfx() {
      ...
      if (!this.isSoundEnabled() || !window.Tone) return;
      this._ensureUiSfxAudio().then(function () {
        var _this5$_uiSfxSynth$ge;
        if (!_this5._uiSfxSynth) return;
        var oldEnv = _objectSpread({}, _this5._uiSfxSynth.get().envelope);
        var oldOsc = (_this5$_uiSfxSynth$ge = _this5._uiSfxSynth.get().oscillator) === null || _this5$_uiSfxSynth$ge === void 0 ? void 0 : _this5$_uiSfxSynth$ge.type;
        _this5._uiSfxSynth.set({
          oscillator: {
            type: "sine"
          },
          envelope: {
        ...
        function () {
          ["C4", "G4", "C5", "E5"].forEach(function (n) {
            return _this5._uiSfxSynth.triggerAttackRelease(n, 0.9, now, 0.6);
          });
          ["G5", "A5", "B5", "C6", "D6", "E6", "G6"].forEach(function (n, i) {
            _this5._uiSfxSynth.triggerAttackRelease(n, 0.08, now + 0.25 + i * 0.06, 0.35);
          });
        },
        // 2) Rising broken chord + final hit
        function () {
          ["C5", "E5", "G5", "B5", "D6", "G6"].forEach(function (n, i) {
            _this5._uiSfxSynth.triggerAttackRelease(n, 0.11, now + i * 0.08, 0.44);
          });
          ["C6", "E6", "G6"].forEach(function (n) {
            return _this5._uiSfxSynth.triggerAttackRelease(n, 0.28, now + 0.62, 0.5);
          });
        },
        // 3) Two chord swells
        function () {
          ["A3", "E4", "A4", "C5"].forEach(function (n) {
            return _this5._uiSfxSynth.triggerAttackRelease(n, 0.45, now, 0.45);
          });
          ["F4", "A4", "C5", "F5"].forEach(function (n) {
            return _this5._uiSfxSynth.triggerAttackRelease(n, 0.52, now + 0.35, 0.48);
          });
          ["C5", "F5", "A5"].forEach(function (n) {
            return _this5._uiSfxSynth.triggerAttackRelease(n, 0.24, now + 0.78, 0.4);
          });
        },
        // 4) Sparkly step run + octave landing
        function () {
          ["E5", "G5", "A5", "B5", "D6", "E6", "G6", "A6"].forEach(function (n, i) {
            _this5._uiSfxSynth.triggerAttackRelease(n, 0.075, now + i * 0.055, 0.34);
          });
          ["A5", "A6", "C7"].forEach(function (n) {
            return _this5._uiSfxSynth.triggerAttackRelease(n, 0.20, now + 0.52, 0.42);
          });
        },
        // 5) Major lift arpeggio
        function () {
          ["D4", "A4", "D5", "F#5"].forEach(function (n) {
            return _this5._uiSfxSynth.triggerAttackRelease(n, 0.36, now, 0.45);
          });
          ["D5", "F#5", "A5", "D6", "F#6"].forEach(function (n, i) {
            _this5._uiSfxSynth.triggerAttackRelease(n, 0.095, now + 0.2 + i * 0.065, 0.4);
          });
        },
        // 6) Warm cadence
        function () {
          ["G3", "D4", "G4", "B4"].forEach(function (n) {
            return _this5._uiSfxSynth.triggerAttackRelease(n, 0.4, now, 0.4);
          });
          ["C4", "E4", "G4", "C5"].forEach(function (n) {
            return _this5._uiSfxSynth.triggerAttackRelease(n, 0.44, now + 0.32, 0.46);
          });
          ["E5", "G5", "C6"].forEach(function (n) {
            return _this5._uiSfxSynth.triggerAttackRelease(n, 0.22, now + 0.72, 0.4);
          });
        },
        // 7) Fast gamey sparkle
        function () {
          ["C6", "D6", "E6", "G6", "A6", "G6", "E6", "C7"].forEach(function (n, i) {
            _this5._uiSfxSynth.triggerAttackRelease(n, 0.06, now + i * 0.048, 0.3);
          });
          ["G6", "C7"].forEach(function (n) {
            return _this5._uiSfxSynth.triggerAttackRelease(n, 0.2, now + 0.48, 0.38);
          });
        },
        // 8) Two-step fanfare
        function () {
          ["F4", "C5", "A5"].forEach(function (n, i) {
            _this5._uiSfxSynth.triggerAttackRelease(n, 0.16, now + i * 0.06, 0.45);
          });
          ["G4", "D5", "B5"].forEach(function (n, i) {
            _this5._uiSfxSynth.triggerAttackRelease(n, 0.16, now + 0.28 + i * 0.06, 0.48);
          });
          ["C5", "E5", "G5", "C6"].forEach(function (n) {
            return _this5._uiSfxSynth.triggerAttackRelease(n, 0.26, now + 0.54, 0.44);
          });
        },
        // 9) Descend then resolve up
        function () {
          ["A6", "G6", "E6", "D6", "C6"].forEach(function (n, i) {
            _this5._uiSfxSynth.triggerAttackRelease(n, 0.08, now + i * 0.06, 0.34);
          });
          ["E6", "G6", "C7"].forEach(function (n) {
            return _this5._uiSfxSynth.triggerAttackRelease(n, 0.24, now + 0.4, 0.42);
          });
        },
        // 10) Big finish hit
        function () {
          ["C4", "E4", "G4", "C5"].forEach(function (n) {
            return _this5._uiSfxSynth.triggerAttackRelease(n, 0.34, now, 0.48);
          });
          ["E5", "G5", "B5", "D6", "E6"].forEach(function (n, i) {
            _this5._uiSfxSynth.triggerAttackRelease(n, 0.09, now + 0.18 + i * 0.055, 0.38);
          });
          ["C6", "E6", "G6", "C7"].forEach(function (n) {
            return _this5._uiSfxSynth.triggerAttackRelease(n, 0.3, now + 0.58, 0.5);
          });
        }];
    ...
    value: function _playPerfectGameBonusSfx() {
      ...
      this._ensureUiSfxAudio().then(function () {
        ...
        fanfare.forEach(function (n, i) {
          _this6._uiSfxSynth.triggerAttackRelease(n, 0.09, now + i * 0.06, 0.62);
        });
        var hit = ["C6", "G6", "C7", "E7"];
        hit.forEach(function (n) {
          return _this6._uiSfxSynth.triggerAttackRelease(n, 0.35, now + 0.48, 0.46);
        });
        setTimeout(function () {
          try {
            _this6._uiSfxSynth.set({
    ...
    value: function _wireStaffTools() {
      ...
      this.$staffEl.off("staff:noteState._log.".concat(this.ns)).on("staff:noteState._log.".concat(this.ns), function (e, data) {
        var full = (0,_staff_staffUtils_js__WEBPACK_IMPORTED_MODULE_1__.spellNoteFromState)(_this7.staff, data.step, data.accidentalClass);
        var letterOnly = full.replace(/\d+$/, "");
        if (_this7.showLetterNames) {
          _this7.$staffEl.find(".note[data-note-id=\"".concat(data.noteId, "\"] .lettername")).text(letterOnly);
        }
        if (data.source === "fixed") {
          var _this7$_onFixedNoteSt;
          _this7._fixedNote = {
          ...
          (_this7$_onFixedNoteSt = _this7._onFixedNoteState) === null || _this7$_onFixedNoteSt === void 0 || _this7$_onFixedNoteSt.call(_this7, data, full, letterOnly);
        }
...
/***/ "./resources/js/music/games/chords/ChordsChallenge.js"
/*!************************************************************!*\
  !*** ./resources/js/music/games/chords/ChordsChallenge.js ***!
  \************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   ChordsChallenge: () => (/* binding */ ChordsChallenge)
/* harmony export */ });
...
var ChordsChallenge = /*#__PURE__*/function (_BaseStaffGame) {
  function ChordsChallenge() {
    var _this;
    var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    _classCallCheck(this, ChordsChallenge);
    var defaults = {
      staffEl: "#staff",
      basePoints: 1,
      firstTryBonus: 2,
    ...
    var merged = _objectSpread(_objectSpread(_objectSpread({}, defaults), options), {}, {
      ...
      triadQualities: Array.isArray(options.triadQualities) && options.triadQualities.length ? options.triadQualities.slice() : Object.keys(ChordsChallenge.TRIAD_QUALITY_FULL_NAME_MAP)
    });
    ...
    _this = _callSuper(this, ChordsChallenge, [_objectSpread(_objectSpread({}, merged), {}, {
  ...
  // ------------------------ UI labels ------------------------
  _inherits(ChordsChallenge, _BaseStaffGame);
  return _createClass(ChordsChallenge, [{
    key: "_setTriadUI",
    ...
    value: function _formatShortLabelHtml(shortLabel) {
      var safe = this._escapeHtml(shortLabel);
      ...
      return withOslash.replace(/(^[A-G](?:bb|b|##|#)?)o(?=\d|$)/, "$1<sup>o</sup>");
    }
  }, {
    key: "_triadShortName",
    value: function _triadShortName(root, quality) {
      var _ChordsChallenge$TRIA;
      ...
      var suffix = (_ChordsChallenge$TRIA = ChordsChallenge.TRIAD_QUALITY_SHORT_SUFFIX_MAP[q]) !== null && _ChordsChallenge$TRIA !== void 0 ? _ChordsChallenge$TRIA : "";
    ...
    value: function _triadFullName(root, quality) {
      ...
      var r = String(root || "").trim();
      var q = String(quality || "").trim();
      var qWord = ChordsChallenge.TRIAD_QUALITY_FULL_NAME_MAP[q] || q;
    ...
    value: function _refreshTriadUILabels() {
      ...
      var fullLabel = root ? this._triadFullName(root, q, this._currentSeventhType) : ChordsChallenge.TRIAD_QUALITY_FULL_NAME_MAP[q] || q;
      if ((_this$$intervalLabel = this.$intervalLabel) !== null && _this$$intervalLabel !== void 0 && _this$$intervalLabel.length) this.$intervalLabel.html(this._formatShortLabelHtml(shortLabel));
      if ((_this$$intervalFull = this.$intervalFull) !== null && _this$$intervalFull !== void 0 && _this$$intervalFull.length) this.$intervalFull.text(fullLabel);
    }
  }, {
    ...
    value: function _pickRootAndBassForTriad(quality) {
      ...
      if (allowInv && fixedList.length) {
        ...
        if (viable.length) return (0,_staff_staffUtils_js__WEBPACK_IMPORTED_MODULE_1__.pickOne)(viable);
    ...
    value: function _pickChordSpec() {
      ...
      var poolRaw = Array.isArray(this.opts.triadQualities) && this.opts.triadQualities.length ? this.opts.triadQualities : Object.keys(ChordsChallenge.TRIAD_QUALITY_FULL_NAME_MAP);
      var pool = poolRaw.length ? poolRaw : ["major", "minor", "diminished", "augmented"];
      var quality = pool[Math.floor(Math.random() * pool.length)];
      if (quality === "major") return {
        quality: quality,
        seventhType: (0,_staff_staffUtils_js__WEBPACK_IMPORTED_MODULE_1__.pickOne)(["7", "maj7"])
      };
      ...
      if (quality === "diminished") return {
        quality: quality,
        seventhType: (0,_staff_staffUtils_js__WEBPACK_IMPORTED_MODULE_1__.pickOne)(["7", "dim7"])
      };
    ...
    value: function _onCheck() {
      ...
      var roleToSemis = expected.length === 3 ? {
        0: 0,
        2: expected[0],
        4: expected[1],
        6: expected[2]
    ...
    value: function _computeHintAnswers() {
      ...
      var buildHintAtStep = function buildHintAtStep(id, step, targetSemis) {
        ...
        var accClass = _this4._toneAccidentalClass(rootMidi, step, targetSemis);
...
_defineProperty(ChordsChallenge, "TRIAD_QUALITY_FULL_NAME_MAP", {
  major: "major",
  minor: "minor",
  augmented: "augmented",
  diminished: "diminished"
});
_defineProperty(ChordsChallenge, "TRIAD_QUALITY_SHORT_SUFFIX_MAP", {
  major: "",
  minor: "m",
  augmented: "aug",
  diminished: "°"
...
/*!********************************************!*\
  ...
  \********************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _chords_ChordsChallenge_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./chords/ChordsChallenge.js */ "./resources/js/music/games/chords/ChordsChallenge.js");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function ownKeys(e, r) { var t = Object.keys(e); if (Object.getOwnPropertySymbols) { var o = Object.getOwnPropertySymbols(e); r && (o = o.filter(function (r) { return Object.getOwnPropertyDescriptor(e, r).enumerable; })), t.push.apply(t, o); } return t; }
function _objectSpread(e) { for (var r = 1; r < arguments.length; r++) { var t = null != arguments[r] ? arguments[r] : {}; r % 2 ? ownKeys(Object(t), !0).forEach(function (r) { _defineProperty(e, r, t[r]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t)) : ownKeys(Object(t)).forEach(function (r) { Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r)); }); } return e; }
function _defineProperty(e, r, t) { return (r = _toPropertyKey(r)) in e ? Object.defineProperty(e, r, { value: t, enumerable: !0, configurable: !0, writable: !0 }) : e[r] = t, e; }
...
var game = new _chords_ChordsChallenge_js__WEBPACK_IMPORTED_MODULE_0__.ChordsChallenge(_objectSpread(_objectSpread({}, options), {}, {
  clefUrls: clefUrls
}));
game.start();
})();
