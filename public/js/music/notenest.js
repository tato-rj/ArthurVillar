...
var NoteNest = /*#__PURE__*/function (_BaseStaffGame) {
  function NoteNest() {
    ...
    _this._keyboardSyncPatched = false;
    _this._keyboardAccidentalPreviewPatched = false;
    _this.keyboard = new _shared_PianoKeyboardUi_js__WEBPACK_IMPORTED_MODULE_3__.PianoKeyboardUi({
      rootSelector: "#keyboard",
      namespace: "".concat(_this.ns, ".keyboard")
    });
    return _this;
  }
  ...
  return _createClass(NoteNest, [{
    ...
    key: "_wireKeyboardSync",
    value: function _wireKeyboardSync() {
      var _this2 = this;
      ...
      this.staff.moveNote = function () {
        ...
        _this2._syncKeyboardMarkerFromStaff();
        return out;
      };
      ...
      this.$staffEl.off("staff:noteState.".concat(this.ns, ".keyboard")).on("staff:noteState.".concat(this.ns, ".keyboard"), function (e, data) {
        if ((data === null || data === void 0 ? void 0 : data.source) !== "user") return;
        _this2._syncKeyboardMarkerFromStaff();
      });
    }
  }, {
    key: "_wireKeyboardAccidentalPreview",
    value: function _wireKeyboardAccidentalPreview() {
      var _this3 = this;
      ...
      $tools.draggable("option", "drag", function (event, ui) {
        ...
        _this3._syncKeyboardMarkerFromAccidentalPreview();
      });
      $tools.draggable("option", "stop", function (event, ui) {
        ...
        _this3._syncKeyboardMarkerFromStaff();
      });
    }
  }, {
    key: "_keyboardKeySelectorFor",
    value: function _keyboardKeySelectorFor(letter, accidentalClass, octave) {
      return this.keyboard.keyForNote(letter, accidentalClass, octave);
    }
  }, {
    key: "_syncKeyboardMarkerFromAccidentalPreview",
    value: function _syncKeyboardMarkerFromAccidentalPreview() {
      var _this$staff;
      ...
      var $nextKey = this._keyboardKeySelectorFor(noteState === null || noteState === void 0 ? void 0 : noteState.letter, previewAccidentalClass, noteState === null || noteState === void 0 ? void 0 : noteState.octave);
      this.keyboard.syncActiveKey($nextKey);
    }
  }, {
    key: "_syncKeyboardMarkerFromStaff",
    value: function _syncKeyboardMarkerFromStaff() {
      var notes = this._collectUserNotes();
      var note = notes.length ? notes[0] : null;
      var $nextKey = $();
      if (note && Number.isFinite(note.step)) {
        ...
        $nextKey = this._keyboardKeySelectorFor(noteState === null || noteState === void 0 ? void 0 : noteState.letter, note.accidentalClass, noteState === null || noteState === void 0 ? void 0 : noteState.octave);
      }
      this.keyboard.syncActiveKey($nextKey);
    }
  }, {
    ...
    value: function _collectUserNotes() {
      ...
      return this.$staffEl.find(".note").toArray().map(function (el) {
        var _this4$staff$_getAtta, _this4$staff;
        var $note = $(el);
        var noteId = String($note.attr("data-note-id") || "");
        if (!noteId || _this4.staff.isNoteFixed(noteId)) return null;
        var top = parseFloat($note.css("top"));
        var step = Number.isFinite(top) ? _this4.staff.yToStep(top) : null;
        var accidentalClass = ((_this4$staff$_getAtta = (_this4$staff = _this4.staff)._getAttachedAccidentalClass) === null || _this4$staff$_getAtta === void 0 ? void 0 : _this4$staff$_getAtta.call(_this4$staff, noteId)) || null;
        return {
          noteId: noteId,
          step: step,
...
var PianoKeyboardUi = /*#__PURE__*/function () {
  ...
  return _createClass(PianoKeyboardUi, [{
    ...
    value: function syncActiveKey($nextKey) {
      var nextNoteName = this.noteNameForKey($nextKey);
      if (this._activeNoteName && this._activeNoteName === nextNoteName) return this;
      this._hideAllMarkers();
      this._activeNoteName = null;
      if ($nextKey !== null && $nextKey !== void 0 && $nextKey.length) {
    ...
    value: function _showMarker($marker) {
      ...
      $marker.removeClass("animate__animated animate__jello").show();
      // eslint-disable-next-line no-unused-expressions
