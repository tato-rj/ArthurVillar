  ...
  return _createClass(BaseStaffGame, [{
    ...
    value: function _playRunStartFanfareSfx() {
      ...
      this._ensureUiSfxAudio().then(function () {
        ...
        motif.forEach(function (_ref) {
          ...
          _this9._uiSfxSynth.triggerAttackRelease(notes, dur, now + t, vel);
        });
      });
    }
    ...
    value: function _wireStaffTools() {
      ...
      this.$staffEl.off("staff:noteState._log.".concat(this.ns)).on("staff:noteState._log.".concat(this.ns), function (e, data) {
        ...
        if (_this11.showLetterNames) {
          _this11.$staffEl.find(".note[data-note-id=\"".concat(data.noteId, "\"] .lettername")).text(letterOnly);
        }
    ...
    value: function _wireFirstNoteLearningTracker() {
      ...
      this.$staffEl.off("staff:userNoteAdded._learn.".concat(this.ns)).on("staff:userNoteAdded._learn.".concat(this.ns), function () {
        var _this12$$handPointer2, _this12$$handPointer3;
        if (_this12._hasLearnedFirstNote()) {
          var _this12$$handPointer, _this12$$handPointer$;
          (_this12$$handPointer = _this12.$handPointer) === null || _this12$$handPointer === void 0 || (_this12$$handPointer$ = _this12$$handPointer.hide) === null || _this12$$handPointer$ === void 0 || _this12$$handPointer$.call(_this12$$handPointer);
          _this12.$staffEl.off("staff:userNoteAdded._learn.".concat(_this12.ns));
          return;
        }
        _this12._markLearnedFirstNote();
        (_this12$$handPointer2 = _this12.$handPointer) === null || _this12$$handPointer2 === void 0 || (_this12$$handPointer3 = _this12$$handPointer2.hide) === null || _this12$$handPointer3 === void 0 || _this12$$handPointer3.call(_this12$$handPointer2);
        _this12.$staffEl.off("staff:userNoteAdded._learn.".concat(_this12.ns));
      });
    }
  }, {
    ...
    value: function _armUiGates() {
      ...
      this.$staffEl.off("staff:userNoteAdded._uiGate.".concat(this.ns)).on("staff:userNoteAdded._uiGate.".concat(this.ns), function () {
        _this14._userNotesSinceGate += 1;
        if (!_this14._instructionsRemoved && _this14._userNotesSinceGate >= needForInstructions) {
          $("#instructions").remove();
          _this14._instructionsRemoved = true;
        }
        if (_this14._userNotesSinceGate >= needForCheck) {
          $("#check").removeClass("invisible");
          _this14.$staffEl.off("staff:userNoteAdded._uiGate.".concat(_this14.ns));
        }
      });
    }
    ...
    value: function _removeAllHintNotes() {
      ...
      ids.forEach(function (id) {
        return _this15.staff.removeNote(id);
      });
      this._activeHintIds = [];
    }
  }, {
    ...
    value: function _removeAllUserNotesForHint() {
      ...
      $userNotes.each(function (_, el) {
        ...
        if (id) _this16.staff.removeNote(id);
      });
    }
  }, {
    key: "_randomFreeStep",
    ...
    value: function _attachHintBlinkRemoval(noteId) {
      ...
      $note.off("animationend.hint.".concat(noteId, " webkitAnimationEnd.hint.").concat(noteId)).one("animationend.hint.".concat(noteId, " webkitAnimationEnd.hint.").concat(noteId), function () {
        _this17.staff.removeNote(noteId);
        _this17._activeHintIds = (_this17._activeHintIds || []).filter(function (x) {
          return x !== noteId;
        });
      });
    }
    ...
    value: function _runSuccessFeedbackTransition() {
      ...
      var _ref5 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
        ...
        $interval = _ref5$$interval === void 0 ? null : _ref5$$interval,
        _ref5$delayMs = _ref5.delayMs,
        delayMs = _ref5$delayMs === void 0 ? 800 : _ref5$delayMs,
        _ref5$onDone = _ref5.onDone,
        onDone = _ref5$onDone === void 0 ? null : _ref5$onDone;
...
/***/ "./resources/js/music/games/intervalslab/IntervalsLab.js"
/*!***************************************************************!*\
  !*** ./resources/js/music/games/intervalslab/IntervalsLab.js ***!
  \***************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   IntervalsLab: () => (/* binding */ IntervalsLab)
/* harmony export */ });
...
var IntervalsLab = /*#__PURE__*/function (_BaseStaffGame) {
  function IntervalsLab() {
    var _this;
    var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    _classCallCheck(this, IntervalsLab);
    var defaults = {
      staffEl: "#staff",
      basePoints: 1,
      firstTryBonus: 2,
    ...
    var merged = _objectSpread(_objectSpread(_objectSpread({}, defaults), options), {}, {
      ...
      intervals: Array.isArray(options.intervals) ? options.intervals.slice() : Object.keys(IntervalsLab.INTERVAL_FULL_NAME_MAP)
    });
    ...
    _this = _callSuper(this, IntervalsLab, [_objectSpread(_objectSpread({}, merged), {}, {
  ...
  // ------------------------ interval UI ------------------------
  _inherits(IntervalsLab, _BaseStaffGame);
  return _createClass(IntervalsLab, [{
...
_defineProperty(IntervalsLab, "INTERVAL_FULL_NAME_MAP", {
  m2: "minor 2nd",
  M2: "major 2nd",
  m3: "minor 3rd",
  M3: "major 3rd",
...
(() => {
/*!**************************************************!*\
  !*** ./resources/js/music/games/intervalslab.js ***!
  \**************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _intervalslab_IntervalsLab_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./intervalslab/IntervalsLab.js */ "./resources/js/music/games/intervalslab/IntervalsLab.js");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function ownKeys(e, r) { var t = Object.keys(e); if (Object.getOwnPropertySymbols) { var o = Object.getOwnPropertySymbols(e); r && (o = o.filter(function (r) { return Object.getOwnPropertyDescriptor(e, r).enumerable; })), t.push.apply(t, o); } return t; }
function _objectSpread(e) { for (var r = 1; r < arguments.length; r++) { var t = null != arguments[r] ? arguments[r] : {}; r % 2 ? ownKeys(Object(t), !0).forEach(function (r) { _defineProperty(e, r, t[r]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t)) : ownKeys(Object(t)).forEach(function (r) { Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r)); }); } return e; }
function _defineProperty(e, r, t) { return (r = _toPropertyKey(r)) in e ? Object.defineProperty(e, r, { value: t, enumerable: !0, configurable: !0, writable: !0 }) : e[r] = t, e; }
...
var game = new _intervalslab_IntervalsLab_js__WEBPACK_IMPORTED_MODULE_0__.IntervalsLab(_objectSpread(_objectSpread({}, options), {}, {
  clefUrls: clefUrls
}));
game.start();
})();
