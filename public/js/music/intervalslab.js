...
var IntervalsLab = /*#__PURE__*/function (_BaseStaffGame) {
  ...
  return _createClass(IntervalsLab, [{
    ...
    key: "_directionWord",
    value: function _directionWord(direction) {
    ...
    value: function _setIntervalUI(intervalAbbr) {
      ...
      var fullName = this._fullNameForInterval(abbr);
      this.prompt.setLong(this._isStrictDirection() ? "".concat(fullName, " ").concat(this._directionWord(this._currentIntervalDirection)) : fullName);
    }
  }, {
    key: "_normalizeOnOff",
