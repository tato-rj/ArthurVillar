  ...
  return _createClass(NotePython, [{
    ...
    value: function _explodeSnakeAndEndGame() {
      ...
      var explodeNow = function explodeNow() {
        ...
        setTimeout(function () {
          ...
          _this6.$board.find(".board-cell .food-note").remove();
        }, 80);
      };
    ...
    value: function _animateSnakeFinalCelebrate() {
      ...
      $cells.each(function (_, el) {
        ...
        // eslint-disable-next-line no-unused-expressions
        el && el.offsetWidth;
        $el.addClass("animate__animated animate__shakeY").off("animationend.".concat(_this9.ns, "SnakeCelebrate webkitAnimationEnd.").concat(_this9.ns, "SnakeCelebrate")).one("animationend.".concat(_this9.ns, "SnakeCelebrate webkitAnimationEnd.").concat(_this9.ns, "SnakeCelebrate"), function () {
    ...
    value: function _advanceSnake() {
      ...
      var eatenFoodIdx = this._foods.findIndex(function (f) {
        return _this0._sameCell(f, next);
      });
      ...
      var hitSelf = this._snake.some(function (segment, idx) {
        ...
        if (!willGrow && idx === _this0._snake.length - 1) return false;
        return _this0._sameCell(segment, next);
      });
      if (hitSelf) {
      ...
      if (isCorrectFood) {
        ...
        if (!this._isPracticeMode() && this._roundsCompleted >= (Number(this.opts.numOfChallenges) || 4)) {
          ...
          this._finalResultsTimeoutId = setTimeout(function () {
            _this0._finalResultsTimeoutId = null;
            _this0._showFinalResults();
          }, 1600);
          return;
        }
        this._runSuccessFeedbackTransition({
          ...
          onDone: function onDone() {
            if (_this0._isGameOver) return;
            _this0._setIntervalUIWithDirection(_this0._pickInterval(), _this0._pickIntervalDirection());
    ...
    value: function _runCountdownThenStart() {
      ...
      steps.forEach(function (label, i) {
        var tid = setTimeout(function () {
          _this1._showCountdownStep(label);
          if (label === "GO!") _this1._playCountdownGoFanfareSfx();else _this1._playCountdownBeepSfx();
        }, i * stepMs);
        _this1._countdownTimeouts.push(tid);
      });
      var doneTid = setTimeout(function () {
        _this1.$countdown.remove();
        _this1.$countdown = $();
        _this1.$countdownText = $();
        _this1._placeInitialSnake();
        _this1._directionQueue = [];
        _this1._spawnFoods(2, {
          preferredRow: _this1._rows - 2
        });
        _this1._ensureTargetFoodPresent();
        _this1._renderEntities();
        _this1._startLoop();
    ...
    value: function _awaitStartThenCountdown() {
      ...
      this.$startBtn.off("click.".concat(this.ns, "Start")).one("click.".concat(this.ns, "Start"), function (e) {
        e.preventDefault();
        _this10.$startBtn.hide();
        _this10._runCountdownThenStart();
      });
    }
  }, {
    key: "_startLoop",
    ...
    key: "start",
    value: function start() {
      var _this$$feedback, _this$$feedback$hide;
      this._stopLoop();
    ...
    value: function _showFinalResults() {
      ...
      if (perfectGame) {
        var tid = setTimeout(function () {
          var _this12$$doublePoints, _this12$$doublePoints2;
          (_this12$$doublePoints = _this12.$doublePoints) === null || _this12$$doublePoints === void 0 || (_this12$$doublePoints2 = _this12$$doublePoints.show) === null || _this12$$doublePoints2 === void 0 || _this12$$doublePoints2.call(_this12$$doublePoints);
          _this12._playPerfectGameBonusSfx();
        }, 1750);
        this._countdownTimeouts.push(tid);
      } else {
      ...
      (0,_shared_finalResults_js__WEBPACK_IMPORTED_MODULE_1__.renderFinalResultsOverlay)({
        ...
        clearCountupTimers: function clearCountupTimers() {
          return _this12._clearFinalCountupTimers();
        },
        countupTimers: this._finalCountupTimeouts,
        animateMetrics: function animateMetrics() {
          return _this12._animateFinalMetricsWithSfx();
        },
        playFinalSfx: function playFinalSfx() {
          return _this12._playFinalSfx();
        }
      });
    }
  }, {
