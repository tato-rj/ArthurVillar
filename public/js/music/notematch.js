...
/***/ "./resources/js/music/games/notematch/NoteMatch.js"
/*!*********************************************************!*\
  !*** ./resources/js/music/games/notematch/NoteMatch.js ***!
  \*********************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   NoteMatch: () => (/* binding */ NoteMatch)
/* harmony export */ });
...
var NoteMatch = /*#__PURE__*/function (_NoteNest) {
  function NoteMatch() {
    var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    _classCallCheck(this, NoteMatch);
    return _callSuper(this, NoteMatch, [_objectSpread(_objectSpread({}, options), {}, {
      namespace: "noteMatch",
  ...
  _inherits(NoteMatch, _NoteNest);
  return _createClass(NoteMatch, [{
    ...
    value: function _setPromptForTarget() {
      this.prompt.setShort("", {
        html: false
      }).clearLong().hideDirection().hide();
    }
  }, {
    key: "_removeInstructions",
    value: function _removeInstructions() {
    ...
    key: "_renderTargetNote",
    value: function _renderTargetNote(target) {
    ...
    value: function _isUserAnswerCorrect() {
      ...
      var targetMidi = this._noteMidi(this._targetNote);
      ...
      return this._playedNoteConfirmed && Number.isFinite(targetMidi) && playedMidi === targetMidi;
    }
  }, {
    ...
    value: function _playedNoteWrongFeedbackText() {
      ...
      if (Number.isFinite(playedMidi) && Number.isFinite(targetMidi) && pitchClass(playedMidi) === pitchClass(targetMidi)) {
        ...
        return _playedName ? "You played ".concat(_playedName, " in the wrong octave...") : "You played the right note in the wrong octave...";
      }
...
var NoteNest = /*#__PURE__*/function (_BaseStaffGame) {
  ...
  return _createClass(NoteNest, [{
    ...
    value: function _playedNoteFeedbackName(midi) {
      ...
      return (0,_shared_noteNames_js__WEBPACK_IMPORTED_MODULE_2__.displayNoteName)("".concat(base).concat(accidental).concat(octave));
    }
  }, {
    ...
    value: function _playedNoteFeedbackNameWithoutOctave(midi) {
      ...
      var base = this._showSolfegeNoteNames() ? NoteNest.LETTER_TO_SOLFEGE[letter] || letter : letter;
      return (0,_shared_noteNames_js__WEBPACK_IMPORTED_MODULE_2__.displayNoteName)("".concat(base).concat(accidental));
    }
  }, {
    key: "_playedNoteWrongFeedbackText",
    value: function _playedNoteWrongFeedbackText() {
    ...
    value: function _bindBlockMarkerDismiss() {
      ...
      $(document).off("pointerdown.".concat(this.ns, ".blockTooltip mousedown.").concat(this.ns, ".blockTooltip"), "*").on("pointerdown.".concat(this.ns, ".blockTooltip mousedown.").concat(this.ns, ".blockTooltip"), function (e) {
        if ($(e.target).closest(".".concat(_this7._blockMarkerClass)).length) return;
        _this7._hideBlockMarkerTooltip();
      });
    }
  }, {
...
(() => {
/*!***********************************************!*\
  !*** ./resources/js/music/games/notematch.js ***!
  \***********************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _notematch_NoteMatch_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./notematch/NoteMatch.js */ "./resources/js/music/games/notematch/NoteMatch.js");
var _game$start;
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function ownKeys(e, r) { var t = Object.keys(e); if (Object.getOwnPropertySymbols) { var o = Object.getOwnPropertySymbols(e); r && (o = o.filter(function (r) { return Object.getOwnPropertyDescriptor(e, r).enumerable; })), t.push.apply(t, o); } return t; }
function _objectSpread(e) { for (var r = 1; r < arguments.length; r++) { var t = null != arguments[r] ? arguments[r] : {}; r % 2 ? ownKeys(Object(t), !0).forEach(function (r) { _defineProperty(e, r, t[r]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t)) : ownKeys(Object(t)).forEach(function (r) { Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r)); }); } return e; }
...
var game = new _notematch_NoteMatch_js__WEBPACK_IMPORTED_MODULE_0__.NoteMatch(_objectSpread(_objectSpread({}, options), {}, {
  clefUrls: clefUrls
}));
