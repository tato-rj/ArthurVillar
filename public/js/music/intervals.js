...
var IntervalChallenge = /*#__PURE__*/function (_BaseStaffGame) {
  function IntervalChallenge() {
    var _this;
    var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    ...
    var clefPool = IntervalChallenge._normalizeClefPoolStatic(merged.clefs != null ? merged.clefs : merged.clef);
    _this = _callSuper(this, IntervalChallenge, [_objectSpread(_objectSpread({}, merged), {}, {
  ...
  // ------------------------ interval UI ------------------------
  _inherits(IntervalChallenge, _BaseStaffGame);
  return _createClass(IntervalChallenge, [{
    ...
    value: function _pickFixedNote() {
      ...
      return {
        step: (0,_staff_staffUtils_js__WEBPACK_IMPORTED_MODULE_1__.randomInt)(0, 7),
    ...
    value: function _computeHintAnswer() {
      ...
      var tryDir = function tryDir(dir) {
        ...
        var accidentalClass = _this4._accidentalClassFromOffset(off);
    ...
    key: "_normalizeClefPoolStatic",
    value: function _normalizeClefPoolStatic(clefsOrSingle) {
      ...
      var normalized = raw.map(function (c) {
        return (0,_staff_staffUtils_js__WEBPACK_IMPORTED_MODULE_1__.normalizeClef)(c);
      }).filter(Boolean);
      var uniq = [];
...
var game = new _interval_IntervalChallenge_js__WEBPACK_IMPORTED_MODULE_0__.IntervalChallenge(_objectSpread(_objectSpread({}, options), {}, {
  clefUrls: clefUrls
}));
game.start();
})();
